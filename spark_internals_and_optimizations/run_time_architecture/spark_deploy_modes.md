...
└────────┬───────────────────────┬────────────────┘
         │                       ↑
         │ 2. Create AM          │ 3. Driver requests
         │    Container          │    executor containers
         ↓                       │
┌────────────────────────────────┼─────────────────┐
│              YARN Cluster      │                 │
│                                │                 │
...
│                    │                              │
│                    │ 5. Start executors           │
│                    │    in allocated containers   │
│                    ↓                              │
│  ┌─────────────────────────────────────┐         │
│  │  Worker Node 2                      │         │
│  │  ┌───────────────────────────┐      │         │
│  │  │  Executor Container 1     │      │         │
│  │  │  (allocated by YARN RM)   │      │         │
│  │  │  ┌─────────────────────┐  │      │         │
│  │  │  │  Executor (JVM)     │←─┼──────┼─────────┤
│  │  │  │  (started by Driver)│  │      │         │
│  │  │  └─────────────────────┘  │      │         │
...
4. YARN RM allocates containers (not shown in diagram but happens 
